	...
	<div class="container">
		<div class="row">
			<div class="container tableGenre">
				...
				<a href="http://localhost/Projets/W2_alternatif/My_cinema/?controller=listeGenre&id_genre=<?php echo $genre[$i]['id_genre']; ?>"><strong>&nbsp<?php echo ucfirst($genre[$i]['nom']); ?></strong>&nbsp
				</a>
				...
				<?php if(isset($_GET['id_genre'])) {
					...
					for($i=0; $i<count($genreFilm); $i++) {
						if ($i == 0)
							echo "<h3>" .ucfirst($genreFilm[$i]['nom']). " : </h3>";

						echo "<li>".$genreFilm[$i]['titre']."</li>";
					}
